...
### Changed
- 🚀 **Upgrade GPT Models**: Updated all default GPT models to `gpt-5.2-codex`, replacing older `gpt-5.1-codex` and `gpt-5.1-codex-max` versions for improved code generation and reasoning.
